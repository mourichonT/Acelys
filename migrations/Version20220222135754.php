 ...
 */
final class Version20220222135754 extends AbstractMigration
{
    ...
    {
        $this->connection->executeQuery("INSERT INTO admin (username, roles, password) VALUES ('admin', '[\"ROLE_ADMIN\"]', '\$2y\$13\$z4cqQg36CxRvoEOb9VVtAu9T7.DVzaYEHnMyfh27/Kv7MsB/1e82.')");
    }
